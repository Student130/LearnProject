...
INSERT INTO `lp_adres_do` VALUES (1,1),(2,3),(3,7);
...
INSERT INTO `lp_adres_z` VALUES (1,2),(2,4),(3,8);
...
CREATE TABLE `lp_komunikator` (
  ...
  `id_kierowcy_nadawca` int NOT NULL,
  `id_kierowcy_odbiorca` int NOT NULL,
  `id_pasazera_nadawca` int NOT NULL,
  `id_pasazera_odbiorca` int NOT NULL,
  PRIMARY KEY (`id_komunikator`),
  KEY `FKlp_komunik979368` (`id_rezerwacja`),
  KEY `FKlp_komunik292006` (`id_kierowcy_nadawca`),
  KEY `FKlp_komunik269648` (`id_kierowcy_odbiorca`),
  KEY `FKlp_komunik598807` (`id_pasazera_nadawca`),
  KEY `FKlp_komunik283992` (`id_pasazera_odbiorca`),
  CONSTRAINT `FKlp_komunik269648` FOREIGN KEY (`id_kierowcy_odbiorca`) REFERENCES `lp_profil_kierowcy` (`id_kierowcy`),
  CONSTRAINT `FKlp_komunik283992` FOREIGN KEY (`id_pasazera_odbiorca`) REFERENCES `lp_uzytkownicy` (`id_pasazera`),
  CONSTRAINT `FKlp_komunik292006` FOREIGN KEY (`id_kierowcy_nadawca`) REFERENCES `lp_profil_kierowcy` (`id_kierowcy`),
  CONSTRAINT `FKlp_komunik598807` FOREIGN KEY (`id_pasazera_nadawca`) REFERENCES `lp_uzytkownicy` (`id_pasazera`),
  CONSTRAINT `FKlp_komunik979368` FOREIGN KEY (`id_rezerwacja`) REFERENCES `lp_rezerwacja` (`id_rezerwacja`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lp_logowanie` VALUES (1,'2021-03-21 05:06:06',1,1),(2,'2020-07-15 06:12:05',1,2),(3,'2021-02-18 11:25:30',1,3),(4,'2021-01-30 14:45:22',1,4);
...
INSERT INTO `lp_ogloszenie` VALUES (1,'2021-05-03 22:00:00','05:45:00','2021-03-21 07:00:00',300.00,4,'300',_binary '','Jade tam',1,2,1,1),(2,'2021-04-02 22:00:00','06:00:00','2021-03-21 14:00:00',200.00,2,'200',_binary '','Jade rowniez tam',3,2,3,2),(3,'2021-08-11 22:00:00','08:00:00','2021-02-20 15:00:00',100.00,3,'150',_binary '','Jade bo chce',2,1,2,3);
...
INSERT INTO `lp_opinia` VALUES (1,3,4,4,'Srednio sie jechalo','2021-03-15 20:00:00',_binary '',1,1,1),(2,5,5,5,'Polecam goraco ta mordeczke ','2021-01-01 15:45:21',_binary '\0',2,2,2),(3,1,1,1,'Nie polecam, takim ludziom powinno sie odbierac prawo jazdy. ','2021-02-27 12:05:12',_binary '\0',3,3,3);
...
INSERT INTO `lp_pojazd` VALUES (1,'Opel','Insygnia','Sedan',2000,150,2010,600,_binary '',1),(2,'Wolkswagen','Golf','Hatchback',1600,116,1999,300,_binary '',4),(3,'Mazda','RX7','Sedan',2200,170,2015,400,_binary '',2),(4,'Audi ','RS4','Combi',6000,450,2016,700,_binary '',3);
...
INSERT INTO `lp_profil_kierowcy` VALUES (1,'078825182','Jestem kierowca z 8 letnim doswiadczeniem. ',1),(2,'872984000','Uwielbiam podrozowac i zwiedzac rozne ciekawe miejsca. Posiadam prawo jazdy o 4 lat',2),(3,'723952123','Jestem kierowca o 5 lat. Wczesniej jezdzilem jako kierowca zawodowy. ',3),(4,'157287512','Posiadam duze doswiadczenie za kolkiem. 3 lata bylem kierowca busa, przewoz osob',4);
...
INSERT INTO `lp_regulamin` VALUES (1,'Nie mozna jesc przy komputerze '),(2,'Nie mozna spac przy komputerze ');
...
INSERT INTO `lp_rezerwacja` VALUES (1,2,300,_binary '\0',_binary '','2021-03-02 23:00:00',1,1),(2,1,200,_binary '\0',_binary '','2021-04-21 06:00:00',2,2),(3,3,100,_binary '\0',_binary '','2021-01-29 11:00:00',3,3);
...
-- Dump completed on 2021-03-26 12:21:23
